...
<body style="background-color: #E6F9E6;">
	...
	<div class="container-fluid text-center"
		...
		<h2>Tribal Cart</h2>
		<h6>ALL TRIBAL ITEMS ARE AVAILABLE</h6>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="index.jsp?type=woodentoys">WoodenToys</a></li>
							<li><a href="index.jsp?type=tribalpaintings">TribalPaintings</a></li>
							<li><a href="index.jsp?type=clothes">Clothes</a></li>
							<li><a href="index.jsp?type=tribalcrafts">TribalCrafts</a></li>
							<li><a href="index.jsp?type=musicalinstruments">MusicalInstruments</a></li>
							<li><a href="index.jsp?type=householditems">HouseHoldItems</a></li>
						</ul></li>
				</ul>
			</div>
		</div>
